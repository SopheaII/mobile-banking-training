...
class Home: UIViewController {
    ...
    private let bodyMenu: UIStackView = {
        ...
        lazy var imageViews = menuName.map({(icon: MenuIcon) -> UIStackView in
        ...
        let bodyMenu = UIStackView(arrangedSubviews: imageViews)
        bodyMenu.axis = .horizontal
        bodyMenu.distribution = .equalSpacing
        bodyMenu.translatesAutoresizingMaskIntoConstraints = false
